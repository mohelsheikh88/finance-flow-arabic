...
type FormState = {
  ...
  customer_type_id: string | null; country: string | null; address_ar: string;
...
const emptyForm: FormState = {
  ...
  customer_type_id: null, country: null, address_ar: "",
...
function PartnersPage() {
  ...
  const openEdit = (p: any) => {
    setForm({
      ...
      customer_type_id: p.customer_type_id, country: p.country, address_ar: p.address_ar ?? "",
