export const translations = {
  ar: {
    ...
    rfq: {
      ...
      lines: "البنود",
      vendorsInvited: "الموردين المدعوين",
      tabLines: "البنود المطلوبة",
      tabVendors: "الموردين والعروض",
      tabCompare: "المقارنة والترسية",
      linesHint: "حدد الأصناف والكميات المطلوبة قبل دعوة الموردين",
      addLine: "إضافة بند",
      pickProductOrType: "اختر صنف أو اكتب وصف",
      freeTextDescription: "وصف حر (اختياري لو مفيش صنف محدد)",
      qty: "الكمية",
      targetPrice: "السعر المستهدف",
      vendorsHint: "ادعُ الموردين اللي عايز تطلب منهم عرض سعر وسجّل عروضهم أول ما توصلك",
      manageInvited: "إدارة الموردين المدعوين",
      noVendorsInvited: "مفيش موردين مدعوين لسه",
      markDeclined: "اعتذر المورد",
      recordQuote: "تسجيل العرض",
      noQuotesYet: "لسه مفيش عروض أسعار متسجّلة",
      winner: "الفائز بالبند",
      awardSelected: "ترسية المحدد",
      awarded: "تمت الترسية بنجاح",
      readyToConvert: "الطلب اتّرسى — جاهز يتحوّل لأمر شراء",
      convertToPo: "تحويل لأمر شراء",
      markSent: "تحديد كـ مُرسل",
      quoteDate: "تاريخ العرض",
      validUntil: "صالح لغاية",
      deliveryDays: "مدة التوريد (أيام)",
      availableQty: "الكمية المتاحة",
      lineQuotes: "أسعار البنود",
      days: "يوم",
      status: {
        draft: "مسودة",
        sent: "مُرسل للموردين",
        quotes_received: "عروض واردة",
        awarded: "تمت الترسية",
        converted: "تم التحويل لأمر شراء",
        cancelled: "ملغي",
      },
      vendorStatus: {
        invited: "مدعو",
    ...
    common: {
      ...
      sectionAccessDerivedHint: "الوصول للقسم الرئيسي بيتحدد تلقائيًا حسب الشاشات المفعّلة تحته — الاختيار يكون على مستوى الشاشة نفسها بس.",
      subModulesFor: "الشاشات الفرعية —",
      subModules: "الشاشات الفرعية",
    ...
    nav: {
      ...
      purchaseDashboard: "لوحة تحكم المشتريات",
    ...
    purchase: {
      ...
      kpiTotalSpend: "إجمالي المشتريات",
      kpiTotalOrders: "عدد الأوامر",
      kpiDraftOrders: "أوامر مسودة",
      kpiDraftHint: "محتاجة مراجعة",
      kpiActiveVendors: "الموردين النشطين",
      kpiAvgOrder: "متوسط قيمة الأمر",
      chartMonthlySpend: "المصروفات الشهرية (آخر 12 شهر)",
      chartStatusBreakdown: "توزيع حالات الأوامر",
      chartTopVendors: "أكبر الموردين إنفاقًا",
      chartSpendByCategory: "الإنفاق حسب التصنيف",
      recentOrders: "أحدث أوامر الشراء",
      reportOrders: "تقرير أوامر الشراء",
      reportVendorSpend: "تقرير إنفاق الموردين",
      reportProductSpend: "تقرير إنفاق المنتجات",
      reportCategorySpend: "تقرير الإنفاق حسب التصنيف",
      share: "النسبة",
      lastOrder: "آخر عملية",
      ...
      uomLockedHint: "وحدة القياس متحددة من تعريف الصنف ومش قابلة للتعديل هنا",
      isBoxProduct: "يُستلم كصندوق (Box)",
      isBoxHint: "لو مفعّل، هتقدر تحدد محتويات الصندوق من أصناف تانية",
      boxContents: "محتويات الصندوق",
      addBoxContent: "إضافة محتوى",
      contentProduct: "الصنف",
      boxContentsHint: "حدد الأصناف وكمياتها اللي جوه الصندوق ده",
      barcode: "الباركود",
      generateBarcode: "توليد باركود",
      productTypesTitle: "أنواع المنتجات",
      productTypesHint: "الأنواع المعرّفة هنا هي اللي هتظهر في قائمة \"Product Type\" عند تعريف صنف جديد.",
      newProductType: "نوع منتج جديد",
      tracksInventory: "يتتبّع المخزون",
      tracksInventoryHint: "لو مفعّل: هيظهر حقل وحدة القياس وحد إعادة الطلب. لو معطّل: هيظهر حقل حساب المصروف بدلًا منها (زي الخدمات).",
      tracksInventoryYes: "مخزون (سلعة)",
      tracksInventoryNo: "غير مخزّن (خدمة/أخرى)",
  ...
  en: {
    ...
    rfq: {
      ...
      tabLines: "Requested Lines",
      tabVendors: "Vendors & Quotes",
      tabCompare: "Compare & Award",
      linesHint: "Define the products/quantities you need before inviting vendors",
      addLine: "Add Line",
      pickProductOrType: "Pick a product or type a description",
      freeTextDescription: "Free-text description (optional if no product picked)",
      qty: "Qty",
      targetPrice: "Target Price",
      vendorsHint: "Invite the vendors you want a quote from, then record their quote as it comes in",
      manageInvited: "Manage Invited Vendors",
      noVendorsInvited: "No vendors invited yet",
      markDeclined: "Mark Declined",
      recordQuote: "Record Quote",
      noQuotesYet: "No quotes recorded yet",
      winner: "Line Winner",
      awardSelected: "Award Selected",
      awarded: "Awarded successfully",
      readyToConvert: "RFQ awarded — ready to convert to a Purchase Order",
    ...
    common: {
      ...
      sectionAccessDerivedHint: "Section-level access is derived automatically from which screens underneath it are granted — selection only happens at the screen level.",
      subModulesFor: "Sub-Modules —",
    ...
    purchase: {
      ...
      kpiDraftOrders: "Draft Orders",
      kpiDraftHint: "Need review",
      kpiActiveVendors: "Active Vendors",
      kpiAvgOrder: "Avg. Order Value",
      chartMonthlySpend: "Monthly Spend (last 12 months)",
      chartStatusBreakdown: "Order Status Breakdown",
      chartTopVendors: "Top Vendors by Spend",
      chartSpendByCategory: "Spend by Category",
      recentOrders: "Recent Purchase Orders",
      reportOrders: "Purchase Order Report",
      reportVendorSpend: "Vendor Spend Report",
      reportProductSpend: "Product Spend Report",
      reportCategorySpend: "Spend by Category Report",
      share: "Share",
      ...
      uomLockedHint: "Unit of Measure is set from the product definition and can't be changed here",
      isBoxProduct: "Received as a Box",
      isBoxHint: "When on, you can define what other products are inside this box",
      boxContents: "Box Contents",
      addBoxContent: "Add Content",
      contentProduct: "Product",
      boxContentsHint: "List the products and quantities that make up this box",
      barcode: "Barcode",
      generateBarcode: "Generate Barcode",
      productTypesTitle: "Product Types",
      productTypesHint: "Types defined here populate the \"Product Type\" list when creating a product.",
      newProductType: "New Product Type",
      tracksInventory: "Tracks Inventory",
      tracksInventoryHint: "On: shows Unit of Measure + Reorder Point. Off: shows Expense Account instead (like services).",
      tracksInventoryYes: "Stocked (Good)",
      tracksInventoryNo: "Non-stocked (Service/Other)",
