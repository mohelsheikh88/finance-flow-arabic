export const translations = {
  ar: {
    ...
    accounts: {
      ...
      balanceSheet: "الميزانية العمومية",
      incomeStatement: "قائمة الدخل",
      manageTypes: "إدارة المجموعات",
      manageClassifications: "إدارة التصنيفات الأساسية",
      accountTypesTitle: "إدارة مجموعات الحسابات",
      classificationsTitle: "إدارة التصنيفات الأساسية",
      accountTypesNav: "مجموعات الحسابات",
      ...
      typeInUse: "هذه المجموعة مستخدمة في حسابات ولا يمكن حذفها",
